...
Agent Evidence 拥有 trust records：evidence packs、claim maps、source maps、provenance chains、verification、review、replay、redaction、telemetry correlation 与 export manifests。

Evidence 解释 Agent outcome 为什么可信、可评审、可回放、可安全导出。
